package com.budy.pay.response;


import com.budy.pay.entity.Amount;
...
public class KakaoCancelResponse {
    ...
    public static class ApprovedCancelAmount {
        private int total; // 해당 요청으로 취소된 전체 금액
        private int tax_free; // 해당 요청으로 취소된 비과세 금액
        private int vat; // 해당 요청으로 취소된 부가세 금액
    }
